...
camera_distance = 7  # Adjust this value to zoom in/out
camera_pitch = -30  # Adjust the pitch (vertical angle)
camera_yaw = -67  # Adjust the yaw (horizontal angle)
...
def elephant_race_simulation():
    ...
    for i in range(duration):
        for idx, robot_id in enumerate(robot_ids):
            ...
            if idx == 0:  # Elephant 1 moves using movement pattern 1
                movement_sim_1(num_legs, steps, step_height, robot_id, i)
            elif idx == 1:  # Elephant 2 moves in a square wave pattern
                movement_sim_2(num_legs, step_height, robot_id, i)
            elif idx == 2:  # Elephant 3 moves in a triangular wave pattern
                movement_sim_3(num_legs, step_height, robot_id, i)
...
# elephant_simulation_1()
# elephant_simulation_2()
# elephant_simulation_3()
